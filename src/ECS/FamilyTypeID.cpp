...
template class ECS::Internal::FamilyTypeID<IEntity>;

template class ECS::Internal::FamilyTypeID<IComponent>;

template class ECS::Internal::FamilyTypeID<ISystem>;

template class ECS::Internal::FamilyTypeID<Event::IEvent>;
}
}